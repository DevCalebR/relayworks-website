...
export const metadata = { title: "Contact", description: "Start a conversation with RelayWorks about an AI automation, integration, or custom software project." };

export default function ContactPage() {
  return <main className="legal-page studio-page contact-page">
